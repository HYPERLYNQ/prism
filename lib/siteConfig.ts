...
export const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL ?? "https://kromeandco.com").replace(/\/$/, "");
/**
 ...
 * (The deployment domain is still kromeandco.com for now — separate concern,
 * to be migrated when the new domain lands.)
 */
export const SITE_NAME = "Michael Vidal";
export const OWNER_NAME = "Michael Vidal";
